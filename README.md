...
Model and Scaler: Ensure decision_tree_model.pkl and scaler.pkl are present in the root directory.
Run API: Execute python app.py to start the Flask server.
Flask API Usage
